...
function loadStatsPage(){
	...
	for(i = 2; i < table.rows.length; i++){
		team1 = table.rows[i].cells[2].innerHTML;//Read in a cells current value
		team1 = parseInt(team1);

		team2 = table.rows[i].cells[3].innerHTML;//Read in a cells current value
...
function loadPlayersPage(){
	var thing = document.getElementById("player_selector")
...
function switchPlayers(playerNum){
	...
	document.getElementById("avg_p_yards").innerHTML = parseInt(p["pass_yards"])/parseInt(p["games_played"]);
	document.getElementById("avg_r_yards").innerHTML = parseInt(p["rushing_yards"])/parseInt(p["games_played"]);
	document.getElementById("avg_rec_yards").innerHTML = parseInt(p["receiving_yards"])/parseInt(p["games_played"]);
}
